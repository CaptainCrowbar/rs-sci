...
void test_rs_sci_formula_sphere_geometry() {
...
void test_rs_sci_formula_mass_density() {
...
void test_rs_sci_formula_surface_gravity() {

    TEST_NEAR(gravity_from_mass_radius(M_earth_d, R_earth_d), 9.8, 0.01);

}

void test_rs_sci_formula_orbital_period() {
...
void test_rs_sci_formula_hill_sphere() {
...
void test_rs_sci_formula_stellar_luminosity() {
...
void test_rs_sci_formula_stellar_lifetime() {

    TEST_NEAR(main_sequence_lifetime(M_sun_d, L_sun_d), 1e10 * jy_d, jy_d);

}

void test_rs_sci_formula_schwarzschild_radius() {

    TEST_NEAR(schwarzschild_radius(M_sun_d), 2953, 1);
}

void test_rs_sci_formula_magnitude_luminosity() {
...
void test_rs_sci_formula_bolometric_correction() {
...
void test_rs_sci_formula_planet_temperature() {
