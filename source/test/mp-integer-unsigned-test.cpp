...
void test_rs_sci_mp_integer_unsigned_byte_operations() {
    ...
    TRY(a = Mpuint("0x12"));                    TEST_EQUAL(a.bytes(), 1u);
    TRY(a = Mpuint("0x1234"));                  TEST_EQUAL(a.bytes(), 2u);
    TRY(a = Mpuint("0x123456"));                TEST_EQUAL(a.bytes(), 3u);
    TRY(a = Mpuint("0x12345678"));              TEST_EQUAL(a.bytes(), 4u);
    TRY(a = Mpuint("0x123456789a"));            TEST_EQUAL(a.bytes(), 5u);
    TRY(a = Mpuint("0x123456789abc"));          TEST_EQUAL(a.bytes(), 6u);
    TRY(a = Mpuint("0x123456789abcde"));        TEST_EQUAL(a.bytes(), 7u);
    TRY(a = Mpuint("0x123456789abcdef1"));      TEST_EQUAL(a.bytes(), 8u);
    TRY(a = Mpuint("0x123456789abcdef123"));    TEST_EQUAL(a.bytes(), 9u);
    TRY(a = Mpuint("0x123456789abcdef12345"));  TEST_EQUAL(a.bytes(), 10u);
    ...
    TRY(a = Mpuint::read_be(v.data(), v.size()));  TEST_EQUAL(a.str(16), "112233445566778899aabbccddeeff");
    TRY(a = Mpuint::read_le(v.data(), v.size()));  TEST_EQUAL(a.str(16), "ffeeddccbbaa998877665544332211");
