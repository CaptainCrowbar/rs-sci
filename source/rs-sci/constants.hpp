...
namespace RS::Sci {
    ...
    RS_DEFINE_CONSTANT(arcsec,         4.84813'68110'95359'93589'91410'2358e-6);  // rad
    RS_DEFINE_CONSTANT(arcmin,         2.90888'20866'57215'96153'94846'1415e-4);  // rad
    RS_DEFINE_CONSTANT(degree,         1.74532'92519'94329'57692'36907'6849e-2);  // rad
    ...
    RS_DEFINE_CONSTANT(ounce,          0.028'349'523'125);                        // kg
    RS_DEFINE_CONSTANT(pound,          0.453'592'37);                             // kg
    RS_DEFINE_CONSTANT(short_ton,      907.184'74);                               // kg
    RS_DEFINE_CONSTANT(long_ton,       1016.046'908'8);                           // kg
    RS_DEFINE_CONSTANT(pound_force,    4.448'221'615'260'5);                      // N
    RS_DEFINE_CONSTANT(erg,            1e-7);                                     // J
    RS_DEFINE_CONSTANT(foot_pound,     1.355'817'948'331'400'4);                  // J
    RS_DEFINE_CONSTANT(calorie,        4.184);                                    // J
    RS_DEFINE_CONSTANT(kilocalorie,    4184.0);                                   // J
    RS_DEFINE_CONSTANT(ton_tnt,        4.184e9);                                  // J
    RS_DEFINE_CONSTANT(horsepower,     745.699'871'582'270'22);                   // W
    RS_DEFINE_CONSTANT(mmHg,           133.322'387'415);                          // Pa
    RS_DEFINE_CONSTANT(atmosphere,     101'325.0);                                // Pa
    ...
    RS_DEFINE_CONSTANT_2(sidereal_month,                  mon_sid,   2'360'591.6);             // s
    RS_DEFINE_CONSTANT_2(synodic_month,                   mon_syn,   2'551'442.9);             // s
